...
const NotificationPage = lazy(
  () => import("../components/Notifications/NotificationPage"),
);
const DepositWithdrawPage = lazy(
  () => import("../components/Wallet/DepositWithdrawPage"),
);
const BetHistoryPage = lazy(
  () => import("../components/BetRecords/BetHistoryPage"),
);
const UnsettledBetsPage = lazy(
  () => import("../components/BetRecords/UnsettledBetsPage"),
);
const ProfitLossPage = lazy(
  () => import("../components/BetRecords/ProfitLossPage"),
);
const BetStakeSettingsPage = lazy(
  () => import("../components/Account/BetStakeSettingsPage"),
);
const BlogsPage = lazy(() => import("../components/Content/BlogsPage"));
const BlogDetailPage = lazy(
  () => import("../components/Content/BlogDetailPage"),
);
const CMSPage = lazy(() => import("../components/Content/CMSPage"));
const NewsPage = lazy(() => import("../components/Content/NewsPage"));
const NewsDetailPage = lazy(
  () => import("../components/Content/NewsDetailPage"),
);
const SpinWinPage = lazy(
  () => import("../components/Gamification/SpinWinPage"),
);
const DailyRewardsPage = lazy(
  () => import("../components/Gamification/DailyRewardsPage"),
);
const VipPage = lazy(() => import("../components/Gamification/VipPage"));
const AffiliateDashboard = lazy(
  () => import("../components/Affiliate/AffiliateDashboard"),
);
const AffiliatePlayerDetail = lazy(
  () => import("../components/Affiliate/AffiliatePlayerDetail"),
);
const PaymentAccountsPage = lazy(
  () => import("../components/Account/PaymentAccountsPage"),
);
const CasinoBetHistoryPage = lazy(
  () => import("../components/BetRecords/CasinoBetHistoryPage"),
);
const ContactUsPage = lazy(() => import("../components/Content/ContactUsPage"));
const BonusManagerPage = lazy(
  () => import("../components/BonusManager/BonusManagerPage"),
);
const PromotionsPage = lazy(
  () => import("../components/Promotions/PromotionsPage"),
);
const DreamCasinoGame = lazy(
  () => import("../components/LiveCasino/DreamCasinoGame"),
);
const AuraCasinoGame = lazy(
  () => import("../components/LiveCasino/AuraCasinoGame"),
);
const BettingLayout = lazy(() => import("../components/Betting/BettingLayout"));
const BettingHomePage = lazy(
  () => import("../components/Betting/BettingHomePage"),
);
const BettingSportPage = lazy(
  () => import("../components/Betting/BettingSportPage"),
);
const BettingEventPage = lazy(
  () => import("../components/Betting/BettingEventPage"),
);
const BettingMyBetsPage = lazy(
  () => import("../components/Betting/BettingMyBetsPage"),
);
    ...
    <Suspense fallback={<Fallback />}>
      <Routes>
        ...
        <Route
          path="/football"
          element={
            <SportEventPage sportId="1" sportName="Football" sportIcon="⚽" />
          }
        />
        <Route
          path="/soccer"
          element={
            <SportEventPage sportId="1" sportName="Soccer" sportIcon="⚽" />
          }
        />
        <Route
          path="/tennis"
          element={
            <SportEventPage sportId="2" sportName="Tennis" sportIcon="🎾" />
          }
        />
        <Route
          path="/hockey"
          element={
            <SportEventPage sportId="7522" sportName="Hockey" sportIcon="🏒" />
          }
        />
        <Route
          path="/election"
        ...
        <Route element={<PrivateRoute />}>
          <Route element={<AccountLayout />}>
            ...
            <Route
              path="/affiliate/player/:id"
              element={<AffiliatePlayerDetail />}
            />
            <Route
        ...
        {/* Protected route without AccountLayout sidebar */}
        <Route element={<PrivateRoute />}>
