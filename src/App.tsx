...
const Layout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener('openLeftSidebar', handleOpenFilter);
    }, []);
    ...
    const ACCOUNT_PATHS = [
        '/profile', '/kyc', '/change-password', '/notification',
        '/wallet', '/deposit', '/withdraw',
        '/bet-history', '/unsettled-bets', '/profit-loss',
        '/bet-stake-setting', '/payment-accounts', '/casino-bet-history',
        '/spin-win', '/daily-rewards', '/my-vip',
        '/affiliate', '/contact-us', '/bonus-manager',
    ];
    ...
    return (
         ...
         */}
                <main className={`flex-1 w-full max-w-[1920px] mx-auto   md:w-auto md:pb-0 ${isProfilePage ? 'overflow-visible' : 'overflow-auto'
                    }`}>
                    <AppRoutes />
                </main>
