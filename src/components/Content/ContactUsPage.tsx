...
import { FiMail, FiPhone, FiMapPin, FiCheckCircle, FiMessageSquare } from 'react-icons/fi';
    ...
    return (
        <div className="min-h-screen bg-bg-primary">
            ...
            <div className="bg-brand-primary px-6 py-5">
                <h1 className="text-xl font-display font-bold text-white tracking-wide">Contact Us</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="bg-bg-card border border-stroke-light rounded-xl shadow-betting-card overflow-hidden">
                        ...
                        {/*
                          ...
                          FIX: text-brand-text → text-white
                          On bg-brand-primary-dark, text must always be text-white.
                        */}
                        ...
                        <div className="p-5 space-y-5">
                            <p className="text-sm text-brand-text">
                                Have questions or need assistance? Our support team is available 24/7 to help.
                            </p>

                            {[
                                { Icon: FiPhone,  label: 'Phone',   value: '1800-XXX-XXXX',         color: 'text-accent-green'  },
                                { Icon: FiMail,   label: 'Email',   value: 'support@wlssports.com',  color: 'text-accent-yellow' },
                                { Icon: FiMapPin, label: 'Address', value: 'India',                  color: 'text-accent-red'    },
                                ...
                                <div key={label} className="flex items-start gap-3">
                                    ...
                                    */}
                                    <div className="w-10 h-10 bg-brand-primary-dark rounded-xl flex items-center justify-center flex-shrink-0 border border-stroke-light">
                                        <Icon className={`w-5 h-5 ${color}`} />
                                    </div>
                                    <div>
                                        <p className="text-xs font-semibold text-brand-text/60 uppercase tracking-wider">
                                            {label}
                                        </p>
                        ...
                        {submitted ? (
                            <>
                                ...
                                <div className="p-8 flex flex-col items-center justify-center text-center">
                                    ...
                                    <h3 className="text-lg font-bold text-accent-green mb-1">Message Sent!</h3>
                                    ...
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-brand-primary text-white text-sm font-bold rounded-xl hover:opacity-90 transition-opacity"
                                    >
                                        Send Another
                                    </button>
                                </div>
                            ...
                            <>
                                {/*
                                  ...
                                  FIX: FiMessageSquare text-brand-primary → text-white
                                       brand-primary is dark navy — invisible on brand-primary-dark.
                                       text-white always reads on bg-brand-primary-dark.
                                  FIX: text-brand-text → text-white (heading on dark bg)
                                */}
                                <div className="px-5 py-3.5 border-b border-stroke-light bg-brand-primary-dark flex items-center gap-2">
                                    <FiMessageSquare className="w-4 h-4 text-white/70" />
                                    <h2 className="text-xs font-semibold text-white uppercase tracking-wider">
                                        Send a Message
                                    </h2>
                                </div>
                                ...
                                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={submitting}
                                        className="w-full py-3 bg-accent-green text-white font-bold rounded-xl disabled:opacity-50 hover:opacity-90 transition-opacity"
                                    >
