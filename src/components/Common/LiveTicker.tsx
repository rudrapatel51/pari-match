        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          >
            {ticker.map((item, i) => (
              ...
              >
                {/*
                                  Use text-brand-text / opacity utilities — NOT neutral-gray-*.
                                  ...
                                  text-brand-text is always #ffffff regardless of theme — guaranteed
                ...
                {item.league && (
                  <span className="text-sm font-medium whitespace-nowrap text-brand-text opacity-70">
                    {item.league}
                  </span>
                )}

                {item.league && (
                  <span className="text-sm text-brand-text opacity-30">/</span>
                )}

                <span className="text-sm font-semibold whitespace-nowrap text-brand-text">
                  {item.name}
                </span>
              </button>
            ))}
