    ...
    render() {
        ...
        return (
            <div className="flex flex-col items-center justify-center p-6 gap-3 text-center bg-bg-card rounded shadow-betting-card">
                ...
                <p className="text-sm font-semibold text-neutral-gray-800">Something went wrong</p>
                ...
                <button
                    ...
                    className="text-xs bg-brand-primary text-white px-3 py-1.5 rounded hover:opacity-90 transition-opacity"
                >
                    Try again
                </button>
            </div>
