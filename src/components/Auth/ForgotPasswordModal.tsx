...
const ForgotPasswordModal: React.FC = () => {
    ...
    const {
        sendForgotPasswordOtp, isSendingForgotOtp,
        verifyForgotPasswordOtp, isVerifyingForgotOtp,
    ...
    const handleSendOtp = (e: React.FormEvent) => {
        e.preventDefault();
        sendForgotPasswordOtp({ mobile, type: 'forgot_password' }, {
    ...
    const handleVerifyOtp = (e: React.FormEvent) => {
        e.preventDefault();
        verifyForgotPasswordOtp({ mobile, otp, type: 'forgot_password' }, {
            onSuccess: (response) => {
                    ...
                    <form onSubmit={handleSendOtp} className="space-y-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                            />
                            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-gray-600"><FiSmartphone /></div>
                        </div>
                        <button
                            type="submit"
                            disabled={isSendingForgotOtp}
                            className="w-full bg-brand-primary hover:bg-brand-primary-light text-white font-bold py-3.5 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-70"
                        >
                    ...
                    <form onSubmit={handleResetPassword} className="space-y-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                            />
                            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-gray-600"><FiLock /></div>
                        </div>
                        <div className="relative">
                            <input
                                type="password"
                                ...
                                required
                            />
                            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-gray-600"><FiCheck /></div>
                        </div>
                        <button
                            type="submit"
