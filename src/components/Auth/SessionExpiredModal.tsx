      ...
      <div className="bg-bg-white rounded-lg shadow-2xl w-full max-w-sm overflow-hidden animate-scale-in">
        ...
        <div
          className={`h-1.5 w-full ${
            isDeviceConflict ? "bg-accent-red" : "bg-accent-yellow"
          }`}
        />
        ...
        <div className="p-6 flex flex-col items-center text-center gap-4">
          ...
          <div
            className={`p-3 rounded-full ${
              isDeviceConflict ? "bg-accent-red/10" : "bg-accent-yellow/10"
            }`}
          >
            {isDeviceConflict ? (
              <FiMonitor
          ...
          <button
            ...
            className="mt-2 w-full py-2.5 rounded-lg bg-brand-primary text-brand-text text-sm font-semibold hover:bg-brand-primary-dark transition-colors focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2"
          >
            OK, Go to Login
          </button>
        </div>
