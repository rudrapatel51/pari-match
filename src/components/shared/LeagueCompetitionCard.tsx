        ...
        <div className="relative flex-shrink-0 w-72 md:w-auto rounded-xl overflow-hidden cursor-pointer group h-40 select-none">
            ...
            {isLive && (
                <div className="absolute top-3 left-3">
                    <span className="bg-accent-green text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wide">
                        LIVE
                    </span>
                </div>
            )}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3">
                <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-white font-bold text-sm leading-tight line-clamp-2">{league}</span>
                </div>
                <span className="bg-brand-primary text-white text-[10px] font-semibold px-2.5 py-1 rounded-full">
