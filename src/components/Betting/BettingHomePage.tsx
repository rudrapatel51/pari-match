        ...
        <div className="p-3">
            {liveEvents.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 gap-3">
                    ...
                    <p className="text-neutral-gray-700 text-sm">No live events right now</p>
                </div>
            ) : (
                    ...
                    {liveEvents.map((event) => (
                        ...
                        >
                            <div className="flex-1 flex items-center gap-2 min-w-0">
                                ...
                                <span className="text-sm font-medium text-brand-text group-hover:text-brand-primary dark:group-hover:text-brand-text transition-colors truncate">
                                    {event.name}
                                </span>
                                {event.hasBookmaker && (
