  ...
  return (
    <div className="md:hidden grid grid-cols-3 gap-2 px-2 sm:px-4 py-2 bg-brand-primary border-b border-stroke-light pt-3">
      <button
        ...
        className="flex flex-row items-center justify-center gap-1.5 sm:gap-2 px-1 sm:px-4 py-2 sm:py-2.5 rounded-md bg-brand-primary-dark text-brand-text transition-all shadow-sm active:scale-95 touch-manipulation"
      >
