...
export const MarketCard: React.FC<MarketCardProps> = ({
  ...
  const isSessionType = ["session", "ballbyball", "meter", "khado"].includes(
    market.marketType,
  );
  ...
  return (
    <div className="bg-bg-card rounded-xl border border-stroke-light shadow-betting-card overflow-hidden">
      ...
      <div className="flex items-center px-4 py-1.5 bg-bg-light-blue border-b border-stroke-light">
        ...
        {isSessionType ? (
          <>
            <div className="w-16 text-center text-[11px] font-semibold text-odds-lay mx-0.5">
              No
            </div>
            <div className="w-16 text-center text-[11px] font-semibold text-odds-back mx-0.5 ml-2">
              Yes
            </div>
          </>
        ) : (
          <>
            <div className="w-16 text-center text-[11px] font-semibold text-odds-back mx-0.5">
              Back
            </div>
            <div className="w-16 text-center text-[11px] font-semibold text-odds-lay mx-0.5 ml-2">
              Lay
            </div>
          </>
        )}
