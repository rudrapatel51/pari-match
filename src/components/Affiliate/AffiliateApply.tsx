...
const BENEFITS = [
    { icon: FiDollarSign, text: 'Earn commission on every referred player deposit' },
        ...
        <div className="min-h-[60vh] flex items-center justify-center p-4">
            <div className="bg-bg-card border border-stroke-light rounded-2xl shadow-elevated p-8 max-w-md w-full text-center">
                ...
                <p className="text-sm text-neutral-gray-700 mb-6">
                    Share your referral link and earn commission on every deposit,
                    loss, and profit from players you refer.
                </p>
                ...
                <button
                    onClick={handleApply}
                    disabled={applying}
                    className="w-full mt-2 py-3 bg-brand-primary text-white text-sm font-semibold rounded-xl hover:opacity-90 transition-opacity disabled:opacity-60"
                >
