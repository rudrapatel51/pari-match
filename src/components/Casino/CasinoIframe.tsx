...
const CasinoIframe: React.FC<CasinoIframeProps> = ({ url, title = 'Game', onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black z-[9990] flex flex-col">
            <div className="flex items-center justify-between px-4 py-2 bg-neutral-gray-900">
                ...
                {onClose && (
                    <button onClick={onClose} className="text-neutral-gray-300 hover:text-white transition-colors">
