    ...
    return (
        <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-brand-primary cursor-pointer group flex flex-col h-full">
            ...
            <div className="relative m-2 rounded-xl overflow-hidden aspect-[16/9] shrink-0">
                ...
                >
                    <div className="bg-accent-green text-white text-sm font-bold pl-3 pr-6 py-1.5 shadow-lg">
                ...
                {tournament.isActive && (
                    ...
                    >
                        <div className="bg-purple-600 text-white text-xs font-bold pl-6 pr-3 py-1 shadow-lg">
                            ACTIVE
                        </div>
                    </div>
                )}
                    ...
                    <div className="flex items-start space-x-1 sm:space-x-2">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="flex space-x-[2px]">
                                <div className="bg-brand-primary-dark rounded-[3px] w-6 h-7 sm:w-7 sm:h-8 flex items-center justify-center text-white font-bold text-sm sm:text-base shadow-sm">
                            ...
                            <div className="text-brand-white text-[10px] font-bold uppercase mt-1">D</div>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="text-brand-white text-[10px] font-bold uppercase mt-1">H</div>
                        </div>

                        {/* Colon separator — only between H and M */}
                        <div className="text-brand-white font-bold text-sm pb-4 flex items-center">:</div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="text-brand-white text-[10px] font-bold uppercase mt-1">M</div>
                        </div>
                    </div>
                </div>
