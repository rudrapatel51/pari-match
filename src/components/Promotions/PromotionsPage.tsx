...
import { FiGift, FiClock, FiArrowRight, FiStar, FiZap, FiShield } from 'react-icons/fi';
...
const PROMOTIONS: Promotion[] = [
    {
        id: 1,
        title: 'Welcome Bonus',
        description: 'New to WLSBet? Get a massive welcome bonus on your first deposit. Start your betting journey with extra funds!',
        bonus: '200%',
    ...
    },
    {
        ...
        description: 'Bet on cricket matches and earn extra rewards. Special odds boost on IPL, T20, and Test matches every week.',
        bonus: '50%',
    ...
    },
    {
        ...
        description: 'Play your favourite casino games and get weekly cashback on your losses. Never leave empty handed!',
        bonus: '15%',
    ...
    },
    {
        id: 4,
        title: 'Reload Bonus',
        description: 'Keep playing with our daily reload bonus. Deposit every day and receive a bonus on each reload to boost your balance.',
        bonus: '25%',
    ...
    },
    {
        ...
        description: 'Join our exclusive live casino tables and unlock VIP privileges. Enjoy higher limits, personal host, and special tournaments.',
        bonus: 'VIP',
    ...
    },
    {
        id: 6,
        title: 'Refer & Earn',
        description: 'Invite your friends to WLSBet and earn a bonus for every friend who joins and makes their first deposit.',
        bonus: '₹500',
    ...
    },
    {
        ...
        description: 'Place accumulator bets on football leagues and get a bonus on your winnings based on the number of selections.',
        bonus: 'Up to 100%',
    ...
    },
    {
        ...
        description: 'Deposit and play slots to unlock free spins on our most popular slot games. New free spins added every week!',
        bonus: '50',
...
const PromotionCard: React.FC<{ promo: Promotion }> = ({ promo }) => {
    ...
    return (
        ...
        >
            {/* Card banner */}
            <div className={`bg-gradient-to-r ${promo.gradient} relative px-4 pt-4 pb-8 flex items-start justify-between`}>
                {/* Badge */}
                {promo.badge && (
                    <span
                        className={`absolute top-3 right-3 ${promo.badgeColor ?? 'bg-accent-red'} text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider`}
                    >
                        {promo.badge}
                    </span>
                )}
                ...
                <div className="mt-4">
                    ...
                    <p className="text-white text-4xl font-display font-bold leading-none">
                        {promo.bonus}
                    </p>
                </div>
            ...
            <div className={`bg-gradient-to-r ${promo.gradient} h-2`} style={{ clipPath: 'ellipse(55% 100% at 50% 0%)' }} />
            ...
            <div className="flex flex-col flex-1 p-4 gap-3">
                ...
                <div className="flex items-center justify-between text-xs text-neutral-gray-500 border-t border-stroke-light pt-3">
                    ...
                    {promo.minDeposit && (
                        <span>Min: {promo.minDeposit}</span>
                    )}
                    {promo.maxBonus && (
                        <span>Max: {promo.maxBonus}</span>
                    )}
                </div>
...
const PromotionsPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-bg-primary pb-20 md:pb-6">
            {/* Hero Banner */}
            <div className="bg-gradient-to-r from-brand-blue-800 via-brand-blue-700 to-accent-green-dark px-4 py-8 md:py-12 text-white text-center">
                <div className="container-custom">
                    ...
                    <p className="text-white/80 text-sm md:text-base max-w-xl mx-auto">
                        Boost your winnings with our exclusive bonuses, cashback offers, and special promotions updated daily.
                    </p>
                </div>
            </div>
            ...
            <div className="container-custom py-6">
                {/* Featured banner */}
                {featuredPromo && (
                    <div className={`bg-gradient-to-r ${featuredPromo.gradient} rounded-xl p-5 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 shadow-elevated`}>
                        ...
                        <div className="hidden md:flex flex-col items-center">
                            ...
                            <p className="text-white font-display text-7xl font-bold leading-none">
                                {featuredPromo.bonus}
                            </p>
                        </div>
                    </div>
                ...
                <p className="text-neutral-gray-600 text-sm mb-4">
                    Showing <span className="font-semibold text-neutral-gray-800">{filtered.length}</span> offer{filtered.length !== 1 ? 's' : ''}
                </p>
                ...
                {filtered.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        <h3 className="text-neutral-gray-600 font-semibold text-lg mb-1">No offers available</h3>
                        <p className="text-neutral-gray-500 text-sm">Check back soon for new promotions.</p>
                    </div>
                )}

                {/* Terms note */}
                <p className="text-center text-neutral-gray-500 text-xs mt-8">
                    All promotions are subject to terms and conditions. Minimum deposit and wagering requirements apply. Please gamble responsibly.
                </p>
            </div>
        </div>
    );
