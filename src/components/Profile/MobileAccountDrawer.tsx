    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 flex-shrink-0 bg-brand-primary border-b border-stroke-light">
          <h2 className="text-brand-text font-bold text-base tracking-wide">
            My Account
          </h2>
          <button
            onClick={onClose}
            className="p-1.5 rounded-full text-brand-text/80 hover:text-brand-text hover:bg-white/20 transition-colors duration-150"
